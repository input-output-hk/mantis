      ...
      forkBlockHeaderOpt match {
        case Some(forkBlockHeader) =>
          ...
          if (forkResolver.isAccepted(fork)) {
            ...
            ConnectedState(PeerInfo(remoteStatus, remoteStatus.totalDifficulty, true, 0, remoteStatus.bestHash))
          } else {
        ...
        case None =>
          ...
          ConnectedState(PeerInfo(remoteStatus, remoteStatus.totalDifficulty, false, 0, remoteStatus.bestHash))
      }
