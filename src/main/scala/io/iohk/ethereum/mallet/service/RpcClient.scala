...
import io.iohk.ethereum.jsonrpc.TransactionReceiptResponse
...
object RpcClient {
  // TODO: cl option maybe
  private val akkaConfig = Config.config.withValue("akka.loglevel", ConfigValueFactory.fromAnyRef("OFF"))
