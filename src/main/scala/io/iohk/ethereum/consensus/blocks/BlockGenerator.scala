...
/** We use a `BlockGenerator` to create the next block.
  ...
  * In general, a [[BlockGenerator]] depends on and is provided by the [[io.iohk.ethereum.consensus.Consensus]]
  *
  * @note This is generally a stateful object
  * @see [[io.iohk.ethereum.consensus.Consensus.blockGenerator]],
  *     [[io.iohk.ethereum.ledger.BlockPreparator]]
  */
