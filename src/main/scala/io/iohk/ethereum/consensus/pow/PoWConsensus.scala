...
class PoWConsensus private (
  ...
  @volatile private[this] var minerCoordinatorRef: Option[ActorRef[CoordinatorProtocol]] = None
  // TODO in ETCM-773 remove MockedMiner
  @volatile private[this] var mockedMinerRef: Option[akka.actor.ActorRef] = None
  ...
  override def sendMiner(msg: MinerProtocol): Unit =
    msg match {
      ...
      case MinerProtocol.StartMining =>
        ...
        minerCoordinatorRef.foreach(_ ! PoWMinerCoordinator.StartMining(PoWMinerCoordinator.RecurrentMining))
      case MinerProtocol.StopMining =>
        mockedMinerRef.foreach(_ ! MockedMiner.StopMining)
        minerCoordinatorRef.foreach(_ ! PoWMinerCoordinator.StopMining)
