...
class StdOmmersValidator(blockchainConfig: BlockchainConfig, blockHeaderValidator: BlockHeaderValidator) extends OmmersValidator {
  ...
  /** This method allows validating the ommers of a Block. It performs the following validations (stated on
    ...
    * - OmmersValidator.validateDuplicatedOmmer
    *
    ...
    * @return ommers [[OmmersValidator.OmmersValid]] if valid, an [[OmmersValidator.OmmersError]] otherwise
    */
  def validate(
  ...
  /** Validates ommers length
    * based on validations stated in section 11.1 of the Y
    *
    * @param ommers the list of ommers to validate
    * @return ommers [[OmmersValidator.OmmersValid]] if valid,
    *         an [[OmmersValidator.OmmersError.OmmersLengthError]] otherwise
    */
  ...
  /** Validates that each ommer's header is valid
    ...
    * @return ommers [[OmmersValidator.OmmersValid]] if valid, an [[OmmersValidator.OmmersError.OmmersNotValidError]] otherwise
    */
  ...
  /** Validates that each ommer is not too old and that it is a sibling as one of the current block's ancestors
    ...
    * @return ommers [[OmmersValidator.OmmersValid]] if valid, an [[OmmersValidator.OmmersError.OmmersUsedBeforeError]] otherwise
    */
  ...
  /** Validates that there are no duplicated ommers
    * based on validations stated in the white paper (https://github.com/ethereum/wiki/wiki/White-Paper)
    * @param ommers the list of ommers to validate
    * @return ommers [[OmmersValidator.OmmersValid]] if valid, an [[OmmersValidator.OmmersError.OmmersDuplicatedError]] otherwise
    */
