...
class ECIESCoderSpec extends FlatSpec with Matchers {
  ...
  "ECIESCoder" should "pass test for simple encoding from ethereumJ" in {
    ...
    val pub = ECIESCoder.CURVE.getCurve.decodePoint(Hex.decode("04bd27a63c91fe3233c5777e6d3d7b39204d398c8f92655947eb5a373d46e1688f022a1632d264725cbc7dc43ee1cfebde42fa0a86d08b55d2acfbb5e9b3b48dc5"))
  ...
  "ECIESCoder" should "past tests from ethereumJ - test1" in {
    ...
    "802b052f8b066640bba94a4fc39d63815c377fced6fcb84d27f791c9921ddf3e9bf0108e298f490812847109cbd778fae393e80323fd643209841a3b7f110397f37ec61d84cea03dcc5e8385db93248584e8af4b4d1c832d8c7453c0089687a700" shouldBe Hex.toHexString(payload)
  }
