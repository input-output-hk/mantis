...
class CacheBasedBlacklistSpec extends AnyWordSpecLike with Matchers {
  ...
  "CacheBasedBlacklist" should {
    "add elements and respect max number of elements" in withBlacklist(3) { blacklist =>
      ...
      blacklist.add(peer2, 1.minute, "just because")
      blacklist.add(peer3, 1.minute, "just because")
      blacklist.add(peer4, 1.minute, "just because")
      blacklist.add(peer5, 1.minute, "just because")
    ...
    "should expire elements" in {
      ...
      blacklist.add(peer3, 3.minute, "just because")
      blacklist.add(peer4, 2.minute, "just because")
      blacklist.add(peer5, 7.minutes, "just because")
