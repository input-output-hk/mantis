...
//import io.iohk.ethereum.blockchain.sync.PeersClient.{BlacklistPeer, PeersClientMessage}
...
////      val refExpectingReply = peersClient.expectMessage() {
//      val refExpectingReply = peersClient.expectMessage() {
//        case PeersClient.Request(msg, _, _) if msg == secondGetBlockHeadersRequest => peersClient.ref.toClassic.lastSender
//      }
//
...
//
//    val peersClient = createTestProbe[PeersClientMessage]()
////    val peerEventBus = createTestProbe[PeersClientMessage]()
//    val importer = createTestProbe[FetchEvent]()
//    val regularSync = createTestProbe[ProgressProtocol]()
//
...
//      BlockFetcher(
//        peersClient.ref.toClassic,
//        regularSync.ref.toClassic,
//        syncConfig,
