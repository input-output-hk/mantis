...
class ForkValidatorSpec extends FlatSpec with Matchers {
  ...
  "DaoForkValidator" should "determine if it's ETH fork" in {
    assert(Hex.toHexString(daoForkHeader.blockHash.toArray) == "4985f5ca3d2afbec36529aa96f74de3cc10a2a4a6c44f2157a57d2c6059a11bb")
    ...
    assert(validationResult.get.invalidHeaders.head.blockHash sameElements daoForkHeader.blockHash)
  }

  "DaoForkValidator" should "determine if it's ETC fork" in {
    assert(Hex.toHexString(etcForkHeader.blockHash.toArray) == "94365e3a8c0b35089c1d1195081fe7489b528a84b22199c916180db8b28ade7f")
