...
class BlockValidationSpec extends FlatSpec with Matchers with MockFactory {
  ...
  "BlockValidationAfterExecution" should "report valid results from execution as correct" in {
