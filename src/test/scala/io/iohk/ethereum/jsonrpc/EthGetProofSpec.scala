...
import io.iohk.ethereum.domain.{Address, Block, BlockHeader, UInt256, _}
...
class EthGetProofSpec
  ...
  "EthGetProof" should "handle getStorageAt request" in new TestSetup {
    ...
    // TODO PP this call uses blockchain.getAccountStorageAt, instead use EthGetProof and test its logic
    // goal is to test getAccountStorageProofAt that is based on getAccountStorageAt
