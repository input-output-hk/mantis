...
docker tag mantis-base:latest 920648890259.dkr.ecr.eu-west-1.amazonaws.com/mantis-base:latest
docker push 920648890259.dkr.ecr.eu-west-1.amazonaws.com/mantis-base:latest
...
docker tag mantis-dev:latest 920648890259.dkr.ecr.eu-west-1.amazonaws.com/mantis-dev:latest
docker push 920648890259.dkr.ecr.eu-west-1.amazonaws.com/mantis-dev:latest
